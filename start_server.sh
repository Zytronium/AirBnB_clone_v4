HBNB_MYSQL_USER=hbnb_dev HBNB_MYSQL_PWD=hbnb_dev_pwd HBNB_MYSQL_HOST=localhost HBNB_MYSQL_DB=hbnb_dev_db HBNB_TYPE_STORAGE=db python3.8 -m web_dynamic.3-hbnb
# Change "python3.8" to whatever version of python works best for you, perhaps just "python3"
# Change "3-hbnb" (at the very end) to whichever hbnb you are testing. 4-hbnb is the last one. As of writing this, 3-hbnb is the most recent we have done.
